...
const singFilter=[
 
  {
    ...
    options: [
      ...
      { value: '30-50', label: '30$ to 50 $', checked: false },
      { value: '50-100', label: '50$ to 100 $', checked: false },
      { value: '100-200', label: '10$ to 200 $', checked: false },
      { value: '200-300', label: '200$ to 300 $', checked: true },
      { value: '200-1000', label: '200$ to 300 $', checked: true },
...
export default function Product() {
  ...
  const pageNumberValue=searchParamms.get("page") || 0;
...
const handelRadioFilterCahnge=(e,sectionID)=>{
...
useEffect(() => {
  ...
  // Add any other logic, such as making API calls or updating state
}, [
  param.laveThree,
  param.laveOne,
  colorValue,
      ...
      <div>
                              ...
                              <div className="space-y-6">
                                {section.options.map((option, optionIdx) => (
                                  <div key={option.value} className="flex items-center">
                                    ...
                                    onChange={()=>handelRadioFilterCahnge(option.value,section.id)}
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                ...
                <h3 className="text-start text-2xl font-bold">Filter</h3>
                <FilterListIcon/>
                </div>
                            ...
                            {section.options.map((option, optionIdx) => (
                              <div key={option.value} className="flex items-center">
                                <input
                                  ...
                                  onChange={(e)=>handelRadioFilterCahnge(e,section.id)}
                                  id={`filter-${section.id}-${optionIdx}`}
                                  name={`${section.id}[]`}
                                  defaultValue={option.value}
                                  value={option.value}
              ...
              <div className="lg:col-span-3 w-full relative">
                {
                  product.products==""?<ProductNotfound/>:
                
                <div className='product-grid'>
                  
                  {
                    product.products && product.products?.content?.map((item)=><ProductCard {...item}/>)
                  }
          ...
          <section>
            ...
            <Pagination count={product.products?.totalPages} color="secondary" onChange={handelPaginaationChang} />
            </div>
          </section>
        </main>
      </div>
